...
const SearchPage = () => {
  ...
  return (
    <Box>
      ...
      <Typography variant="h6" style={{ margin: '20px' }}>Newest</Typography>
      <Grid container spacing={2}>
        <Grid item xs={4}>
          <Paper elevation={3} className="paperStyle" style={{ boxShadow: 'none' }}>
            ...
            <Typography variant="subtitle1" style={{ margin: '20px' }}>The Shining</Typography>
          </Paper>
        </Grid>
        <Grid item xs={4}>
          <Paper elevation={3}  className="paperStyle" style={{ boxShadow: 'none' }}>
            <img src="7db4f74b-945d-4016-af0d-0c5e192294dd 1.png" alt="Book 2"  className="imageStyle"/>
            <Typography variant="subtitle1" style={{ margin: '20px' }}>1984</Typography>
          </Paper>
        </Grid>
        <Grid item xs={4}>
          <Paper elevation={3} className="paperStyle" style={{ boxShadow: 'none' }}>
            <img src="0fcd449f-a076-480e-a740-07a2c100877a 1.png" alt="Book 3"  className="imageStyle"/>
            <Typography variant="subtitle1" style={{ margin: '20px' }}>Woman</Typography>
          </Paper>
        </Grid>
      </Grid>
    </Box>
