    ...
    return (
        <div>
            ...
            <div className="topup-container">
                <Button variant="outlined" className={`topup-button ${selectedAmount === 100 ? 'selected' : ''}`} onClick={() => handleMoneyButtonClick('100')} 
                style={{
                        backgroundColor: selectedAmount === '100' ? '#FF9800' : 'white',
                        color: selectedAmount === '100' ? 'white' : 'black',
                        marginRight: '50px', fontSize: '17px', borderWidth: '2px', borderRadius: '30px'}}>
                    100
                </Button>
                <Button variant="outlined" className={`topup-button ${selectedAmount === 200 ? 'selected' : ''}`} onClick={() => handleMoneyButtonClick('200')} 
                style={{
                ...
                <Button variant="outlined" className={`topup-button ${selectedAmount === 300 ? 'selected' : ''}`} onClick={() => handleMoneyButtonClick('300')} 
                style={{
                ...
                <Button variant="outlined" className={`topup-button ${selectedAmount === 400 ? 'selected' : ''}`} onClick={() => handleMoneyButtonClick('400')} 
                style={{
                ...
                <Button variant="outlined" className={`topup-button ${selectedAmount === 500 ? 'selected' : ''}`} onClick={() => handleMoneyButtonClick('500')} 
                style={{
            ...
            <div>
                <Button
                    className={`payment-button ${selectedPaymentMethod === 'internetBanking' ? 'selected' : ''}`}
                    onClick={() => handlePaymentClick('internetBanking')}
                    variant="contained"
                    style={{
                        backgroundColor: selectedPaymentMethod === 'internetBanking' ? '#FF9800' : '#f5f5f5',
                        color: selectedPaymentMethod === 'internetBanking' ? 'white' : 'black',
                        fontSize: "17px",
                        textTransform: "none",
                        marginRight: "40px",
                        marginLeft: "100px",
                ...
                <Button 
                    className={`payment-button ${selectedPaymentMethod === 'cash' ? 'selected' : ''}`}
                    onClick={() => handlePaymentClick('cash')}
                    variant="contained"
                    style={{
                        backgroundColor: selectedPaymentMethod === 'cash' ? '#FF9800' : '#f5f5f5',
            ...
            <div style={{ display: "flex", marginLeft: "245px", marginBottom: "100px" }}>
                <Button onClick={handleCancelClick} variant="contained" style={{ width: "150px", height: "55px", marginRight: "40px", textTransform: "none", fontSize: '20px', color: 'black', backgroundColor: 'white' }}>
                    Cancel
                </Button>
                <Button variant="contained" color="primary" style={{ width: "150px", height: "55px", marginRight: "40px", textTransform: "none", fontSize: '20px' }} onClick={handleConfirmClick}>
                    Confirm
                </Button>
            </div>
        </div>
